      ...
      <div className="row popular-products-active">
        <div className="col-xl-3 col-lg-4 col-sm-6 item fruits bread">
          <div className="product-item wow fadeInUp delay-0-2s">
            ...
            <div className="image1">
              <img  src="https://raw.githubusercontent.com/AMH767/image/main/sokiremov/araratabrikos.png" alt="Product" />
            </div>
            <div className="content">
              ...
              <h5>
                <Link href="/product-keshy">Арарат Абрикос</Link>
              </h5>
        ...
        <div className="col-xl-3 col-lg-4 col-sm-6 item seafish fruits">
          <div className="product-item wow fadeInUp delay-0-3s">
            <div className="image1">
              <img src="https://raw.githubusercontent.com/AMH767/image/main/sokiremov/araratapelsin.png" alt="Product" />
            </div>
            <div className="content">
              {/* <div className="ratting">
                <i className="fas fa-star" />
              ...
              <h5>
                <Link href="/product-fyndykjar">Арарат Апельсин</Link>
              </h5>
              {/* <span className="price">
                <span>180 / 100гр</span>
              </span> */}
        ...
        <div className="col-xl-3 col-lg-4 col-sm-6 item bread fruits">
          <div className="product-item wow fadeInUp delay-0-4s">
            ...
            <div className="image1">
              <img src="https://raw.githubusercontent.com/AMH767/image/main/sokiremov/araratkizil.png" alt="Product" />
            </div>
            <div className="content">
              {/* <div className="ratting">
                <i className="fas fa-star" />
              ...
              <h5>
                <Link href="/product-mixorex">Арарат Кизил</Link>
              </h5>
              {/* <span className="price">
                <del>25</del>
                <span>220 / 100гр</span>
        ...
        <div className="col-xl-3 col-lg-4 col-sm-6 item vegetables">
          <div className="product-item wow fadeInUp delay-0-5s">
            ...
            <div className="image1">
              <img src="https://raw.githubusercontent.com/AMH767/image/main/sokiremov/araratoblepixa.png" alt="Product" />
            </div>
            <div className="content">
              {/* <div className="ratting">
                <i className="fas fa-star" />
              ...
              <h5>
                <Link href="/product-details">Арарат Облепиха</Link>
              </h5>
              {/* <span className="price">
                <del>55</del>
                <span>45 / 100гр</span>
        ...
        <div className="col-xl-3 col-lg-4 col-sm-6 item seafish vegetables">
          <div className="product-item wow fadeInUp delay-0-6s">
            <div className="image1">
              <img src="https://raw.githubusercontent.com/AMH767/image/main/sokiremov/cola.png" alt="Product" />
            </div>
            <div className="content">
              {/* <div className="ratting">
                <i className="fas fa-star" />
              ...
              <h5>
                <Link href="/product-details">Кока Кола</Link>
              </h5>
              {/* <span className="price">
                <span>500 / кг</span>
              </span> */}
