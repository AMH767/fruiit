...
const BlogDetails = () => {
  return (
    <Layout>
      <PageBanner pageName={"Температура"} />
            ...
            <div className="col-xl-8 mt-65">
              <div className="blog-details-content">
                ...
                <div className="image my-35">
                  <img src="https://fruitnews.ru/images/2023/08/_65274_p53646.jpg" alt="Blog" />
                </div>
                <p>
                По прогнозам Мировой метеорологической организации (WMO) в следующие 5 лет мировые температуры достигнут
                 рекордных значений. Среднемировая температура воздуха у поверхности земли в этот период
                  времени будет на 1,1 - 1,8 градусов Цельсия выше, чем средняя температура за период с 1850 по 1900 г.
                </p>
                <hr />
                <p>
                Ученые подчеркивают необходимость подготовки к 98% риску того, что как минимум один год из следующих пяти окажется жарче рекордно жаркого 2016 года. 
                Это может иметь влияние на здоровье людей, обеспеченность продовольствием, управление водными ресурсами и общее состояние окружающей среды.
                </p>
